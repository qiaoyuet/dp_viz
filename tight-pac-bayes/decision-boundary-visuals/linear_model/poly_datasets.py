...
class MNISTpoly(data.Dataset):
  ...
  def __str__(self):
    return 'MNISTpoly dataset. SwissrollData location: '+self.root
...
class CIFARpoly16(data.Dataset):
  ...
  def __str__(self):
    return 'Cifar16Poly dataset. SwissrollData location: '+self.root
...
class fashionMNISTpoly(data.Dataset):
  ...
  def __str__(self):
    return 'fashionMNISTpoly dataset. SwissrollData location: '+self.root
